...
export default function DeveloperLandingPage() {
  const features = [
    {
      ...
      description: "Create sophisticated protocol-optimized vaults with our comprehensive SDK and tools.",
      color: "from-[#0A4A7A] to-[#083A5E]"
    },
    {
      icon: <DollarSign className="w-8 h-8" />,
      title: "Earn Revenue Share",
      description: "Get 30% of all fees generated by your vaults through protocol optimization.",
      color: "from-[#FF6B35] to-[#CC5629]"
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Robust Infrastructure",
      description: "Built on battle-tested smart contracts with comprehensive protocol audits.",
  ...
  const developmentSteps = [
    ...
    },
    {
      step: "3",
      title: "Deploy & Launch",
      description: "Deploy your vault to mainnet and start onboarding treasury managers.",
  ...
  const benefits = [
    "Protocol fee sharing program",
    "Comprehensive SDK and documentation",
    "Sandbox testing environment",
    "Smart contract templates",
    "Protocol audit support",
      ...
      <section className="pt-8 pb-20 px-6 relative overflow-hidden bg-linear-to-br from-[#F5F5F5] to-white">
        ...
        <div className="absolute inset-0 overflow-hidden opacity-20">
          {[...Array(20)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute text-[#0A4A7A] font-mono text-xs whitespace-nowrap"
              style={{
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-[#525252] max-w-3xl mx-auto leading-relaxed">
              Create sophisticated DeFi protocol vaults and earn protocol fees. 
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-6">
              <Link
                ...
                className="group px-8 py-4 bg-linear-to-r from-[#0A4A7A] to-[#2E865F] text-white rounded-full font-semibold hover:opacity-90 hover:shadow-lg transition-all duration-300 flex items-center space-x-2"
              >
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {techStack.map((tech, index) => (
              <motion.div
                ...
                className="px-6 py-3 bg-white backdrop-blur-sm rounded-full border border-gray-200 hover:border-[#0A4A7A] hover:shadow-md transition-all duration-300"
              >
                <span className="text-[#0F0F0F] font-medium">{tech.name}</span>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative p-8 bg-white rounded-3xl border-2 border-[#0A4A7A] shadow-xl">
                {/* Terminal mockup */}
                <div className="bg-[#0F0F0F] rounded-xl p-6 font-mono text-sm">
                  ...
                  <div className="space-y-2">
                    <div className="text-[#0A4A7A]">$ npx create-vault my-defi-vault</div>
                    <div className="text-[#737373]">Creating new vault...</div>
                    <div className="text-[#2E865F]">✓ Vault initialized</div>
                    <div className="text-[#2E865F]">✓ Smart contracts generated</div>
                    <div className="text-[#2E865F]">✓ Tests created</div>
                    <div className="text-[#FF6B35]">&gt; <span className="text-white">Ready to deploy!</span></div>
                    <motion.div
                ...
                <motion.div
                  ...
                  className="absolute -top-6 -right-6 px-4 py-2 bg-linear-to-r from-[#FF6B35] to-[#CC5629] rounded-full font-bold text-white shadow-lg"
                >
                  30% Revenue
                </motion.div>
                ...
                <motion.div
                  ...
                  className="absolute -bottom-4 -left-4 px-4 py-2 bg-linear-to-r from-[#2E865F] to-[#1E5A42] rounded-full font-bold text-white shadow-lg"
                >
                  Instant Deploy
                </motion.div>
              </div>
