                    ...
                    (authenticated)
                        ? (
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between w-full px-5 py-3 bg-fundio-sidebar/65 rounded-2xl">
                                        <h2 className="xl:text-lg text-2xl text-white">SAFE LP</h2>
                                        <Select
                                            allowDeselect={false}
                                            wrapperClass="h-9"
                                            placeholder="Filter"
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                        <div className="relative group w-full h-full flex flex-col items-center justify-center lg:gap-5 gap-3 bg-fundio-sidebar lg:rounded-2xl md:rounded-xl rounded-lg p-6 transition-all duration-700 overflow-hidden">
                                            ...
                                            <div className="relative z-10 flex flex-col lg:gap-2 h-fit w-full items-start justify-center">
                                                <h2 className="md:text-2xl text-3xl font-medium text-white">
                                                    {formatNumber(Number(lpKPI?.lps_pending_amount))}
                                                    {" "}
                                                    USDC
                                                </h2>
                                                <h6 className="text-white/80 font-light xl:text-xs lg:text-sm text-lg">LPs Pending Funding</h6>
                                            </div>
                                        </div>
                                        <div className="relative group w-full h-full flex flex-col items-center justify-center lg:gap-5 gap-3 bg-fundio-sidebar lg:rounded-2xl md:rounded-xl rounded-lg p-6 transition-all duration-700 overflow-hidden">
                                            <div className="group-hover:block hidden absolute rotate-x-180 inset-0 z-0">
                                            ...
                                            <div className="relative z-10 flex flex-col lg:gap-2 h-fit w-full items-start justify-center">
                                                ...
                                                <h6 className="text-white/80 font-light xl:text-xs lg:text-sm text-lg">Lifetime Yield Earnings</h6>
                                            </div>
                                        </div>
                                        <div className="relative group w-full h-full flex flex-col items-center justify-center lg:gap-5 gap-3 bg-fundio-sidebar lg:rounded-2xl md:rounded-xl rounded-lg p-6 transition-all duration-700 overflow-hidden">
                                            <div className="group-hover:block hidden absolute rotate-x-180 inset-0 z-0">
                                            ...
                                            <div className="relative z-10 flex flex-col lg:gap-2 h-fit w-full items-start justify-center">
                                                ...
                                                <h6 className="text-white/80 font-light xl:text-xs lg:text-sm text-lg">LPs Funded</h6>
                                            </div>
                                        </div>
                                        <div className="relative group w-full h-full flex flex-col items-center justify-center lg:gap-5 gap-3 bg-fundio-sidebar lg:rounded-2xl md:rounded-xl rounded-lg p-6 transition-all duration-700 overflow-hidden">
                                            <div className="group-hover:block hidden absolute rotate-x-180 inset-0 z-0">
                                            ...
                                            <div className="relative z-10 flex flex-col lg:gap-2 h-fit w-full items-start justify-center">
                                                ...
                                                <h6 className="text-white/80 font-light xl:text-xs lg:text-sm text-lg">YTD Yield Earnings</h6>
                                            </div>
                                        </div>
                                    </div>

                                    <div className="flex flex-col gap-4">
                                        <h2 className="xl:text-lg text-2xl text-white/62">LP Performance Metrics</h2>
                                    ...
                                    <div className="w-full bg-fundio-sidebar rounded-xl lg:p-6 p-4 mt-4">
                                        <h2 className="xl:text-lg text-2xl text-white/62 mb-4">Recent Commitments</h2>
