...
const CoursesPage = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'available': return 'text-[#00E0FF] bg-[#00E0FF]/20';
          ...
          {course.status === 'in-progress' && (
            <div className="space-y-2">
              <div className="flex justify-between text-xs">
                ...
                <span className="text-[#00E0FF]">{course.progress}%</span>
              </div>
          ...
          <button 
            className={`w-full py-3 px-4 rounded-xl font-medium transition-all flex items-center justify-center space-x-2 ${
              course.status === 'locked' 
                ...
                : 'bg-[#00E0FF]/20 text-[#00E0FF] hover:bg-[#00E0FF]/30'
            }`}
              ...
              <div className="flex items-center space-x-4">
                {course.status === 'in-progress' && (
                  <div className="text-right">
                    ...
                    <p className="text-sm font-medium text-[#00E0FF]">{course.progress}%</p>
                  </div>
                )}
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold text-white flex items-center">
            <BookOpen className="w-8 h-8 mr-3 text-[#00E0FF]" />
            Courses
          </h1>
          <p className="text-gray-400 text-lg">Expand your Web3 knowledge and skills</p>
        </div>
      ...
      <div className="relative group">
        ...
        <div className="relative bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 hover:border-purple-500/30 transition-all">
          ...
          <div className="flex items-center space-x-4">
            ...
            <span className="text-sm text-gray-500">Estimated completion: 4-6 weeks</span>
          </div>
        </div>
      </div>
    </div>
